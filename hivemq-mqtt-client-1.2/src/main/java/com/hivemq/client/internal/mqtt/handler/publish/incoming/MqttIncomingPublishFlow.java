...
abstract class MqttIncomingPublishFlow extends FlowWithEventLoop {
	...
	MqttIncomingPublishFlow(final Subscriber<? super Mqtt5Publish> subscriber, final MqttClientConfig clientConfig,final MqttIncomingQosHandler incomingQosHandler, final boolean manualAcknowledgement) { 
		super(clientConfig);
	}
